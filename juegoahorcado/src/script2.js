...
function checkUserLetter() { // Sustitucion por letra acertada o resta el numero de intentos
  ...
  if (!wordToGuess.includes(letterUser)) {
    ...
    switch (numIntentos) {
      case 1:
        let manOne = document.querySelector(`#manOne`);
        manOne.classList.remove(`hiddenMen`);
        manOne.classList.add(`showMen`);
        break;
      case 2:
...
function endGame() {
  ...
  if (!hiddenWord.includes(`_`)) {
    alert(`Felicidades has ganado, te sobraron ${numIntentos} primos ¡gracias por jugar!`);
